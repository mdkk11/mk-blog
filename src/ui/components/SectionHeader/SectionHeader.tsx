...
const SectionHeaderTitle = ({ className, as: Component = "h3", ...props }: SectionHeaderTitleProps) => (
    <Component
        className={cx(
...
interface SectionHeaderSeparatorProps extends React.ComponentProps<typeof Separator> {
    flex?: boolean;
}

const SectionHeaderSeparator = ({ className, flex, ...props }: SectionHeaderSeparatorProps) => (
    <Separator
        className={cx(
            flex ? "flex-1" : "w-8",
            className
...
export const SectionHeader = ({ title, className = '', as }: SectionHeaderProps) => {
    return (
        <SectionHeaderRoot className={className}>
            <SectionHeaderSeparator flex />
            <SectionHeaderTitle as={as}>
                {title}
            </SectionHeaderTitle>

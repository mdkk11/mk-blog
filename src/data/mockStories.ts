export const mockStories = [
    {
        ...
        thumbnail: 'https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=400&h=400&fit=crop',
        stories: [
            {
                id: 's1',
                type: 'image',
                content: 'https://images.unsplash.com/photo-1497215728101-856f4ea42174?w=800&q=80',
                duration: 4000,
                createdAt: new Date()
            },
            {
        ...
        stories: [
            {
                id: 's3',
                type: 'image',
                content: 'https://images.unsplash.com/photo-1558655146-d09347e92766?w=800&q=80',
                createdAt: new Date()
            },
            {
                id: 's4',
...
*Make it bold or go home.*`,
    ...
    },
    {
        ...
        thumbnail: 'https://images.unsplash.com/photo-1544531586-fde5298cdd40?w=400&h=400&fit=crop',
        stories: [
            {
                id: 's5',
                type: 'image',
                content: 'https://images.unsplash.com/photo-1544531586-fde5298cdd40?w=800&q=80',
                createdAt: new Date()
            },
            {
                id: 's6',

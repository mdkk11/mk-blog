...
export const mockArticles: Article[] = [
  {
    ...
    description:
      'Why flat, safely offensive art is dying out and what brutalism offers as an alternative.',
  },
  {
    id: '2',
    ...
    description:
      'Memory safety without garbage collection? Understanding the borrow checker pattern.',
  },
  {
    id: '3',
    category: 'THOUGHTS',
